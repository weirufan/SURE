...
spectral = AgglomerativeClustering(n_clusters=5)
...
np.savetxt('5class_agg.txt',pre_label)
Label = []
...
modelpath = 'model/Agg5_'+str(accuracy)+'_.pkl'
...
def plot_confusion_matrix(cm, classes, normalize=False, title='Confusion matrix', cmap=plt.cm.Blues):
    ...
    plt.savefig('Confusion_matrix_3_class_agg.png')
